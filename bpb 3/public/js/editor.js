  ...
  switch (name) {
    ...
    case 'export':
      renderPlaceholder('Preview &amp; export',
        'Full proposal rendered as HTML. Copy to clipboard for Webflow embed, or publish to a hosted page.',
        'Phase 1.4 — the final Phase 1 piece. Template logic mirrors the Edgerton and 43601 Southerland pages.');
      break;
  }
}
