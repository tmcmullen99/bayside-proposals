...
const ACUITY_URL = 'https://portal-baysidepavers.com/account';

const PROJECT_TYPES = [
  { slug: 'pavers',        label: 'Pavers',          lede: 'Paver patios, walkways, and garden paths — the most common project type. Built to ICPI standards with polymeric jointing sand, your choice of pattern, and a base graded for your soil and climate.' },
...
function renderWarrantySection(slug) {
  ...
  const baysideHtml = bayside
    ? card('Workmanship warranty', bayside.warranty_summary, bayside.warranty_url, true) : '';
